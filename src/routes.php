<?php
    ...
    Route::group(['middleware' => ['web']], function () {
        ...
        # AUTH
        Route::get('login', '\Skydiver\RapydDashboard\Controllers\LoginController@showLoginForm')->name('login');
        Route::get('logout', '\Skydiver\RapydDashboard\Controllers\LoginController@logout'      )->name('logout');
