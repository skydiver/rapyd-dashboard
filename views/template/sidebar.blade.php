<aside class="main-sidebar">
    <section class="sidebar">
        ...
        @if(Auth::user()->role == 'admin')
            ...
            <li class="{{ (Request::is('dashboard/users*') && !Request::is('dashboard/users/logs*')) ? 'active' : '' }}">
                <a href="{{ action('\Skydiver\RapydDashboard\Controllers\UsersController@index') }}"><i class="fa fa-user"></i>&nbsp;<span>Users</span></a>
            </li>
            <li class="{{ Request::is('dashboard/users/logs*') ? 'active' : '' }}">
                <a href="{{ action('\Skydiver\RapydDashboard\Controllers\UsersLogsController@index') }}"><i class="fa fa-list-alt"></i>&nbsp;<span>Users Logs</span></a>
            </li>
